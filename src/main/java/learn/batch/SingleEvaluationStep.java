...
public class SingleEvaluationStep implements Callable<Boolean> {
    private final SampledHierarchy sampledHierarchy;
     ...
     * @param learningDatum
     */
    private SingleEvaluationStep(LearningProperties properties, DynamicNetworkGrammar grammar, SampledHierarchy sampledHierarchy, FormPair learningDatum) {
    ...
    public static SingleEvaluationStep getInstance(LearningProperties learningProperties, DynamicNetworkGrammar grammar, SampledHierarchy sampledHierarchy, FormPair learningDatum) {
