...
/**
 * A RankedConstraint is a composition class that is used to putValue a Constraint in
 * a real-valued stochastic Hierarchy, as proposed by Boersma (1998 et seq).
 * RankedConstraints have a "constraints.ranking value" and "disharmony". They are sorted on
...
public class OldRankedConstraint {
    ...
    /**
     * Compares RankedConstraints first by stratum, then by constraints.ranking values.
     */
    ...
    /**
     * @return A String of the constraint with the constraints.ranking value, separated by a
     * tab
     */
    ...
    /**
     * @return A String of the constraint with the constraints.ranking value and disharmony,
     * separated by a tab
     */
     ...
     * RankedConstraint's constraints.ranking value.
     *
